  ...
  return (
    <div className="flex flex-col gap-4">
        ...
        <div className="rounded-md border border-gray-800 bg-gray-800/30 p-3">
          <div className="mb-2 flex items-center gap-2">
            ...
            {!guardrails.hard_stop_enabled && (
              <span className="rounded bg-gray-700/60 px-1.5 py-0.5 text-[10px] text-gray-500">
                需开启「启用硬停止」生效
              </span>
            )}
          </div>
      ...
      >
        ...
        <div className="rounded-md border border-gray-800 bg-gray-800/20 p-2 text-[11px] leading-relaxed text-gray-500">
          <span className="text-gray-400">验证结果：</span>
      ...
      >
          ...
          {BUILTIN_MIDDLEWARES.map((m) => {
            ...
            return (
              ...
              >
                ...
                {/* rate_limit 的可配置参数 */}
                {enabled && m.hasConfig && (
                  <div className="mt-2 ml-6 border-l border-gray-700 pl-3">
                    <NumberInput
                      label={m.configLabel}
              ...
              {[...getMiddlewares(value)]
                ...
                .map((m, idx) => (
                  <span key={m.name} className="flex items-center gap-1.5">
                    <span className="rounded bg-brand-600/20 px-1.5 py-0.5 text-brand-300">
                      {m.name}
                    </span>
        ...
        <div className="rounded-md border border-gray-800 bg-gray-800/20 p-2 text-[11px] leading-relaxed text-gray-500">
          <span className="text-gray-400">钩子点：</span>
          <span className="ml-1">
